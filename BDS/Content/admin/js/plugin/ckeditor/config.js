...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.filebrowserImageBrowseUrl = '/Content/admin/js/plugin/ckfinder/ckfinder.html?Type=Images';
    config.filebrowserFlashBrowseUrl = '/Content/admin/js/plugin/ckfinder/ckfinder.html?Type=Flash';
    ...
    config.filebrowserImageUploadUrl = '/Images/admin';
